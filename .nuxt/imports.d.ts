...
export { useMath } from '../composables/AI/math';
export { useNeuralNetwork } from '../composables/AI/neuralNetwork';
export { useSensor } from '../composables/AI/sensor';
export { useStatistics } from '../composables/AI/statistics';
export { useApple } from '../composables/Game/apple';
export { useGame } from '../composables/Game/game';
export { useKeyInput } from '../composables/Game/keyInput';
export { useSnake } from '../composables/Game/snake';
